...
class MessageService
{
    ...
    public function listForConversation(Conversation $conversation, int $perPage = 30): LengthAwarePaginator
    {
        ...
        //
        // الترتيب الأحدث‑أولًا مقصود: الصفحة الأولى (بلا `page` بالطلب) يجب
        // أن تُرجع أحدث الرسائل دائمًا، والفرونت يعكس الترتيب محليًا للعرض
        // الزمني الطبيعي، وطلب صفحات لاحقة (page=2...) يجلب رسائل أقدم.
