...
import { ArrowRight, Check, ChevronLeft, CircleCheck, File, Headset, LoaderCircle, MessageSquareOff, MessagesSquare, Paperclip, Send, TriangleAlert, X } from "@lucide/vue";
...
<template>
  <div class="space-y-6">
    ...
    <!-- ==========================================================
         ==================  تاب: المساعد الذكي  =====================
         ========================================================== -->
    <AiChatWorkspace v-if="activeTab === 'assistant'" mode="subscriber" :title="t('messages_page.assistant_title')" />
