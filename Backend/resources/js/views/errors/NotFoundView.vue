...
import { ArrowLeft, ArrowRight, Flag, Headset, House, Search } from "@lucide/vue";
...
<template>
  <div class="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-[#f7f4ea] dark:bg-[#15171a]">
    ...
    <div class="glass-card relative w-full max-w-md p-8 lg:p-10 text-center overflow-hidden">
      <div class="absolute -start-16 -top-16 w-56 h-56 bg-[#8A6D1F]/15 dark:bg-[#D4AF37]/20 rounded-full blur-[80px] pointer-events-none"></div>
      <div class="absolute -end-14 -bottom-16 w-56 h-56 bg-[#52733D]/15 dark:bg-[#8cc35a]/15 rounded-full blur-[80px] pointer-events-none"></div>

      <div class="relative">
        <span class="w-20 h-20 rounded-2xl bg-gradient-to-br from-[#3E582E] to-[#8A6D1F] text-white flex items-center justify-center text-3xl shadow-lg mx-auto mb-5">
          <Search aria-hidden="true" />
        </span>

        <p class="text-[11px] font-bold text-secondary-700 tracking-wide mb-1.5">{{ $t("errors.not_found_eyebrow") }}</p>
        ...
        <div class="mt-5 pt-5 border-t border-[#eee8da] dark:border-white/10">
          ...
          <a
            href="mailto:support@ampere.ps?subject=%D8%A8%D9%84%D8%A7%D8%BA%20%D8%B9%D9%86%20%D9%85%D8%B4%D9%83%D9%84%D8%A9%20-%20%D8%AE%D8%B7%D8%A3%20404"
